...
public class ConvertidorPeso extends Grafica {
    JButton boton, boton1;

    static String[] nombresPeso = {"Gramo", "Kilogramo", "Miligramo", "Onza", "Libra", "Libra troy"};
     double[] valoresPeso = {1.0, 1000.0, 0.001, 28.3495, 453.592, 0.000453592};
    public ConvertidorPeso(String title) {
        super(title, nombresPeso);
        colocarBotones();
    }
    ...
    protected void colocarBotones() {
        ...
        boton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ea) {
                ...
                double valor1 = valoresPeso[lista1.getSelectedIndex()];
                double valor2 = valoresPeso[lista2.getSelectedIndex()];
                /*
